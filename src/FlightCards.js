            ...
            <div className="card-content">
              ...
              <ul className="collection ">
                ...
                <li className="collection-item transparent">
                  <button className="amber darken-1 waves-effect waves-light btn">REVEAL DURATION (-300)</button>
                </li>
                <li className="collection-item transparent">
                  <button className="amber darken-1 waves-effect waves-light btn">REVEAL NUMBER OF STOPS (-300)</button>
                </li>
              </ul>
              <h5>Average</h5>
              <ul className="collection ">
                <li className="collection-item transparent">
                  <button className="amber darken-1 waves-effect waves-light btn">REVEAL PRICE (-300)</button>
                </li>
                <li className="collection-item transparent">
                  <button className="amber darken-1 waves-effect waves-light btn">REVEAL DURATION (-300)</button>
                </li>
